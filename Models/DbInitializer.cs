...
public static class DbInitializer
{
    ...
    /// <summary>
    /// Populates tables with starter data.
    /// </summary>
    /// <param name="applicationBuilder">ASP.NET Core app builder</param>
    /// <returns>The number of state entries written to the database.</returns>
    public static int Seed(IApplicationBuilder applicationBuilder)
    {
        using IServiceScope appScope = applicationBuilder.ApplicationServices.CreateScope();
        BethanysPieShopDbContext context = appScope.ServiceProvider.GetRequiredService<BethanysPieShopDbContext>();
